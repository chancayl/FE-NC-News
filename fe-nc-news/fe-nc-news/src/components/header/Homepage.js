...
function Homepage(props) {
  ...
  return (
    <body className="Homepagetext">
      <h2>Welcome to NC latest News {userinfo && ` ${userinfo.user.name}`}!</h2>
      {userinfo && <img src={userinfo.user.avatar_url} alt="userimg" />}
      <p>
        ...
        <br></br>
        <br></br>
        Right now, you are logged-in as 'jessjelly'. If you want to change to a
        different user, select your favorite one from 'Change user' option.
        <br></br>
        ...
        <br></br>
        If you can't wait for the very last new articles, go and select your
        favorice topic from de "Topics" option
      </p>
    </body>
  );
}
